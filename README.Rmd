...
m <- mapview(l, color = "red")+lclean
m@map %>% setView(-8.55522, 43.25067, zoom = 16)
m
```
...
```{r example 2, cache = TRUE, message=FALSE, results='hide'}
...
```{r example 3, cache = TRUE, message=FALSE, results='hide'}
...
![Notification example...](./man/figures/rpushbullet.png){width=10%}
